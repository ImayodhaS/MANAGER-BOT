...
#menampilkan pesan bahwa bot connect ke program dan bisa dijalankan
@bot.event
async def on_ready():
    print(f'Bot is ready. Logged in as {bot.user}')

#perkenalan bot dan menampilkan bagian informasi informasi bot
...
#informasi informasi mengenai program yang terdapat dalam bot 
...
#untuk menambahkan project baru ke dalam tabel, bot akan menanyakan nama, link, dan status project
...
#menampilkan project project yang telah di tambahkan ke tabel ini
...
#untuk menambahkan skills kedalam project yang sudah terdapat di dalam bot
...
#untuk menghapus suatu project, pilih project yang mau dihapus
...
#mengupdate projects, pengguna akan ditanyakan kembali bagian mana yang mau di update nama, deskripsi, link, status
